...
public class Game extends Thread {
	...
	public void screenDraw(Graphics2D g) {
		if (isResultScreen) {
			...
			g.drawString(titleName + " (" + difficulty + ")", 130, 600);
	...
	public void dropNotes(String titleName) {
		...
		if (titleName.equals("School Song (SangilMedia ver.)")) {
			...
			int startTime = 2350 - (Main.REACH_TIME * 1000);
			Beat.thisTime = startTime;
			int gap = 71;
			...
			if (difficulty.equals("Normal")) {
				beats = new Beat[] { 
						...
						new Beat(gap * 28, "Plus", 4),

						new Beat(gap * 4, "X", 5),
						new Beat(gap * 4, "C", 5),
						new Beat(gap * 4, "SPACE", 5),
						new Beat(gap * 4, ",", 5),
						new Beat(gap * 4, ".", 5),
						new Beat(gap * 4, ",", 5),
						new Beat(gap * 4, "SPACE", 5),
						...
						new Beat(gap * 0, "C", 5),
						new Beat(gap * 4, "C", 5),
						new Beat(gap * 0, "SPACE", 5),
						new Beat(gap * 4, "SPACE", 5),
						new Beat(gap * 0, ",", 5),
						new Beat(gap * 4, ",", 5),
						new Beat(gap * 0, ".", 5),

						new Beat(gap * 16, "Plus", 5),
						new Beat(gap * 4, "X", 6),
						new Beat(gap * 2, "C", 6),
						new Beat(gap * 2, "X", 6),
						new Beat(gap * 2, "C", 6),
				...
				beats = new Beat[] { 
						...
						new Beat(gap * 2, "X", 6),
						new Beat(gap * 0, ".", 6),
						new Beat(gap * 1, "Plus", 6),

						new Beat(gap * 1, "Z", 7),
						new Beat(gap * 0, "SPACE", 7),
						new Beat(gap * 1, "/", 7),
						new Beat(gap * 0, "SPACE", 7),
						new Beat(gap * 1, "X", 7),
						new Beat(gap * 0, "SPACE", 7),
			...
			int startTime = 3550 - (Main.REACH_TIME * 1000);
			Beat.thisTime = startTime;
			int gap = 76;

			if (difficulty.equals("Crazy")) {
				beats = new Beat[] { 
						new Beat(gap * 0, "X", 4), 
						new Beat(gap * 16, "C", 4),
						new Beat(gap * 16, ",", 4), 
						...
						new Beat(gap * 0, ",", 5),
						new Beat(gap * 4, ".", 5),
						new Beat(gap * 2, "Plus", 5),
						new Beat(gap * 2, "Plus", 6),
						new Beat(gap * 2, "Minus", 7),
						...
						new Beat(gap * 28, "SPACE", 7),
						new Beat(gap * 8, "/", 7),
						new Beat(gap * 8, "X", 7),
						new Beat(gap * 8, "SPACE", 7),
						new Beat(gap * 8, "Z", 7),
						new Beat(gap * 4, "X", 7),
						new Beat(gap * 4, "C", 7),
						new Beat(gap * 4, "X", 7),
						...
						new Beat(gap * 6, "Z", 7),
						new Beat(gap / 7 * 4, "X", 7),
						new Beat(gap / 7 * 4, "C", 7),
						new Beat(gap / 7 * 4, "SPACE", 7),
						new Beat(gap / 7 * 4, ",", 7),
						new Beat(gap / 7 * 4, ".", 7),
						new Beat(gap / 7 * 4, "/", 7),
						new Beat(gap * 2, "Minus", 7),
						...
						new Beat(gap * 4, "Minus", 7),

						new Beat(gap * 4, "Minus", 6),
		...
		while (i < beats.length && !isInterrupted()) {
			...
			if (beats[i].getTime() + Beat.thisTime <= gameMusic.getTime()) {
				Note note = new Note(beats[i].getNoteName(), beats[i].getKeyNumber());
				Beat.thisTime += beats[i].getTime();
				note.start();
				noteList.add(note);
				i++;
				dropped = true;
	...
	public void judgeEvent(String judge) {
		if (judge.equals("Miss")) {
			...
			score += (1000000.0 / beats.length) * 0.5;
			EarlyCount++;
			noteCount++;
